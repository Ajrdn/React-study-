...
export default function DarkMode() {
  return (
    <div className='dark'>
      <div className='py-8 px-8 max-w-sm mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6'>
        <img
          className='block mx-auto h-16 md:h-32 lg:h-48 rounded-full sm:mx-0 sm:shrink-0'
        ...
        <div className='text-center space-y-2 sm:text-left'>
          <div className='space-y-0.5'>
            ...
            <p className='text-slate-500 dark:text-slate-300 font-medium'>Product Engineer</p>
          </div>
